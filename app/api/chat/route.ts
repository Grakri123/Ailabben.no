...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = `Du er en profesjonell salgsassistent for Ailabben, et norsk AI-selskap. Din oppgave er å hjelpe potensielle kunder med å finne riktige AI-løsninger for deres bedrift.
